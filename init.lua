...
-- Diagnostic keymaps
vim.keymap.set("n", "[d", function() vim.diagnostic.goto({ next = false }) end, { desc = "Go to previous diagnostic message" })
vim.keymap.set("n", "]d", function() vim.diagnostic.goto({ next = true }) end, { desc = "Go to next diagnostic message" })
